...
from dashapp.pages.process import get_processed_data, get_aircraft_stats, get_aircraft_state_time, get_state_distribution, get_state_distribution_by_hour, get_state_by_airline

print("1.1. current time: - ", datetime.now())
states = get_processed_data()

print("2.1. current time: - ", datetime.now())
state_by_airline = get_state_by_airline(states)
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    html.Table(make_dash_table(state_by_airline)),
                                ],
